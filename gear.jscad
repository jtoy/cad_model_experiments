...
function getParameterDefinitions() {
  return [
    { name: 'numTeeth', caption: 'Number of teeth:', type: 'int', initial: 10,min:5,max:15 ,step:1 },
    { name: 'circularPitch', caption: 'Circular pitch:', type: 'float', initial: 5 ,min:3,max:7,step:0.5},
    { name: 'pressureAngle', caption: 'Pressure angle:', type: 'float', initial: 20 },
    { name: 'clearance', caption: 'Clearance:', type: 'float', initial: 0},
    { name: 'thickness', caption: 'Thickness:', type: 'float', initial: 5,min:3,max:7,step:0.5 },
